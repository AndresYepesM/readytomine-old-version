# Generated by Django 3.1.6 on 2021-05-28 14:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fehc_egreso', models.DateField()),
                ('suceso', models.TextField()),
                ('tracking', models.BigIntegerField()),
                ('estado', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='servicio.estado')),
